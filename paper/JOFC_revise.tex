...
%\author{Heather G. Patsolic$^{\dagger}$,
%    Sancar Adali$^{\ddagger}$, Joshua T. Vogelstein$^{\dddagger}$\\
%        Youngser Park$^{\dagger}$, Carey E. Priebe$^{\dagger}$, Gongkai
%        Li$^{\dagger}$, Vince Lyzinski$^{\ddddagger}$  \\
%\small{$^{\dagger}$Department of Applied Mathematics and Statistics, Johns Hopkins University, Baltimore, MD, USA}\\
%\small{$^{\ddagger}$Raytheon BBN Technologies, Cambridge, MA, USA}}
%\small{$^{\dddagger}$Department of Biomedical Engineering, Johns Hopkins University, Baltimore, MD, USA}}
%\small{$^{\dddagger}$Department of Mathematics, University of Maryland
